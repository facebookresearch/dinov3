:new: [2026-06-12] :fire: Metadata-guided training code and reference recipes (FMoW satellite imagery, HPA-WholeHR fluorescence imagery) are now released on the [`elouan/FINO`](https://github.com/facebookresearch/dinov3/tree/elouan/FINO) branch, accompanying [*Who Needs Labels? Adapting Vision Foundation Models With the Metadata You Already Have*](https://arxiv.org/abs/2606.05107) (Gardès et al., 2026).
